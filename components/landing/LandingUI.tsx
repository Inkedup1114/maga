...
export default function LandingUI() {
  ...
  const emailAddress = "dev@maga6900.live"
      ...
      <div className="container mx-auto px-4 py-6 md:py-12 relative z-20 max-w-7xl">
        <header className="text-center mb-6 md:mb-8 relative">
          ...
          <div className="relative z-10">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl mb-2 md:mb-3 animate-pulse font-sixtyfour font-weight-900 text-red-500">
              MAGA-6900
            </h1>
            <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-red-400 font-sixtyfour font-weight-800 mt-2 md:mt-4">
              M69
            </p>
          </div>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-start">
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="bg-blue-950 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-2xl">
              <h3 className="text-xl md:text-2xl mb-4 text-red-400 font-sixtyfour font-weight-700">Why Ape MAGA-6900?</h3>
              <p className="text-base md:text-xl mb-4 text-red-300 font-sans">
                ...
                We're here to shake things up and bring some nostalgia to the market!
              </p>
              <div className="space-y-2">
                <div className="flex items-center">
                  <FileText className="h-5 w-5 md:h-6 md:w-6 text-red-400 mr-3" />
                  <span className="font-sans text-sm md:text-base text-red-300">Veteran Team </span>
                </div>
                <div className="flex items-center">
                  <Rocket className="h-5 w-5 md:h-6 md:w-6 text-red-400 mr-3" />
                  <span className="font-sans text-sm md:text-base text-red-300">Roadmap is moon at all costs for MAGA</span>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-blue-950 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-2xl">
            <h2 className="text-2xl md:text-4xl mb-6 text-red-400 font-sixtyfour font-weight-800">Tokenomics</h2>
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-center">
                <Shield className="h-6 w-6 md:h-8 md:w-8 text-red-400 mr-4" />
                <div>
                  <h3 className="text-lg md:text-2xl text-red-300 font-sixtyfour font-weight-700">0/0 Taxes</h3>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg md:text-2xl text-red-300 font-sixtyfour font-weight-700">CA Locked</h3>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg md:text-2xl text-red-300 font-sixtyfour font-weight-700">Veteran Team</h3>
